(function () {
  ...
  async function requestMic() {
    ...
    try {
      ...
      setStatus("Microphone access granted. You can return to CallLog.", "ok");
  ...
  async function startIframeMic(deviceId, deviceLabel = "") {
    ...
    try {
      ...
      setStatus(`Recording microphone for CallLog${deviceLabel ? `: ${deviceLabel}` : " using the best available input"}...`);
