...
6. Pin **cauli** from the Chrome extensions menu.

## First Run

1. Open the browser tab where the call/dialer will run.
2. Click the cauli extension icon to open the side panel.
3. Go to **Settings** and confirm it says `cauli v1.1.8`.
